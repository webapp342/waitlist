        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="order-2 lg:order-1">
            ...
            <motion.div
              ...
              className="hidden lg:flex items-center justify-center bg-gradient-to-br from-yellow-400/10 to-yellow-600/5 backdrop-blur-sm border border-yellow-400/20 rounded-2xl p-8 lg:p-12"
            >
          ...
          <div className="order-3 hidden lg:block space-y-6 col-span-2">
